...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "workspace.selectProject": "从侧边栏选择工作目录",
    "workspace.addModels": "点击底部的“模型”按钮添加模型",
    "workspace.stepProject": "从侧边栏选择工作目录",
    ...
    "sidebar.new": "新对话",
    "sidebar.newSessionTitle": "在 {path} 中新建对话",
    "sidebar.refresh": "刷新",
    "sidebar.currentDirectory": "当前工作目录",
    "sidebar.selectProject": "选择工作目录…",
    "sidebar.filterProjects": "筛选工作目录…",
    "sidebar.noMatchingProjects": "没有匹配的工作目录",
    "sidebar.useDefaultDirectory": "使用默认目录",
    "sidebar.customPath": "选择其他文件夹…",
    "sidebar.workRules": "工作规则",
    "sidebar.workRulesCount": "通用 + {count} 份文件",
    "sidebar.workRulesUnavailable": "暂不可读",
    "sidebar.builtInDiscipline": "Pi Task 通用纪律",
    "sidebar.builtInDisciplineScope": "适用于 Pi Task 对话，只读。",
    "sidebar.ruleScope.personal": "个人规则",
    "sidebar.ruleScope.current": "当前目录规则",
    "sidebar.ruleScope.parent": "上级工作区规则",
    "sidebar.noContextRules": "当前目录未加载 AGENTS.md 或 CLAUDE.md。",
    "sidebar.rulesNotSandbox": "规则用于指导 Agent，不是操作系统沙箱。",
    ...
    "chat.refreshModels": "重新加载模型",
    "chat.modelUnavailable": "暂时无法选择模型",
    "chat.modelCwdUnavailable": "这段对话原来的项目文件夹已不存在。请选择一个现有项目文件夹，再重新加载模型。",
    "chat.modelAccessDenied": "该项目文件夹不在 Pi Task 允许访问的本机目录内。",
    "chat.modelLoadUnavailable": "Pi Task 无法加载本机模型列表，请尝试重新加载模型。",
