...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "workspace.selectProject": "Select a working directory from the sidebar",
    "workspace.addModels": "Add models via the Models button at the bottom",
    "workspace.stepProject": "Select a working directory from the sidebar",
    ...
    "sidebar.newSessionTitle": "New conversation in {path}",
    "sidebar.refresh": "Refresh",
    "sidebar.currentDirectory": "CURRENT WORKING DIRECTORY",
    "sidebar.selectProject": "Select working directory…",
    "sidebar.filterProjects": "Filter working directories…",
    "sidebar.noMatchingProjects": "No matching working directories",
    "sidebar.useDefaultDirectory": "Use default directory",
    "sidebar.customPath": "Choose another folder…",
    "sidebar.workRules": "Work rules",
    "sidebar.workRulesCount": "Built-in + {count} file(s)",
    "sidebar.workRulesUnavailable": "Unavailable",
    "sidebar.builtInDiscipline": "Pi Task built-in discipline",
    "sidebar.builtInDisciplineScope": "Applies to Pi Task conversations; read-only.",
    "sidebar.ruleScope.personal": "Personal rule",
    "sidebar.ruleScope.current": "Current-directory rule",
    "sidebar.ruleScope.parent": "Parent workspace rule",
    "sidebar.noContextRules": "No AGENTS.md or CLAUDE.md is loaded for this directory.",
    "sidebar.rulesNotSandbox": "Rules guide the Agent; they are not an operating-system sandbox.",
    ...
    "chat.modelUnavailable": "Model selection unavailable",
    "chat.modelCwdUnavailable": "This conversation's project folder is no longer available. Choose an existing project folder, then reload models.",
    "chat.modelAccessDenied": "This project folder is outside Pi Task's allowed local folders.",
    "chat.modelLoadUnavailable": "Pi Task could not load the local model list. Try reloading models.",
