...
import { TaskReviewCard } from "./tasks/TaskReviewCard";
...
export function ChatWindow({ session, newSessionCwd, onAgentEnd, onSessionCreated, onSessionForked, modelsRefreshKey, chatInputRef, onBranchDataChange, onSystemPromptChange, onSessionStatsChange, onSessionStatsPanelOpen, onContextUsageChange, onOpenFile, pendingTaskStart, onTaskStarted, onTaskStartFailed, activeTask, onTaskStateChange, onTaskReview, onTaskFramingCommitted }: Props) {
  ...
  const {
    ...
    agentRunning, bashRunning, pendingBash, modelNames, modelList, modelsLoading, modelError, modelLoadIssue, modelScopeWarnings, modelThinkingLevels, modelThinkingLevelMaps, toolPreset, thinkingLevel,
    ...
    refreshModels, handleRecallQueue,
  ...
  useEffect(() => {
    if (!activeTaskId || !onTaskStateChange) return;
    void onTaskStateChange();
  }, [activeTaskId, onTaskStateChange, taskUiRequestKey]);
          ...
          <div className="w-full max-w-[820px]">
            ...
            >
              <div style={{ display: "flex", alignItems: "baseline", gap: 10, minWidth: 0, flex: 1, lineHeight: 1.4, overflow: "hidden" }}>
                ...
                <span style={{ fontSize: 22, color: "var(--text)", fontWeight: 700, letterSpacing: 0, flexShrink: 0, whiteSpace: "nowrap" }}>Pi Task</span>
              </div>
