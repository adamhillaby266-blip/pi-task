...
Pi Task's interface uses a small internal i18n layer. It is intentionally kept
...
/** Pi Task Japanese language package. */
...
Pi Task is a user-facing web interface. Internationalization is therefore an
...
support should lower the barrier to using Pi Task, not be treated as a measure
